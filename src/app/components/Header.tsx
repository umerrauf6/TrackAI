    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 20, marginBottom: 30 }}>
      ...
      <div className="glass-panel" style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          <Logo size={28} />
          <span className="brand-font" style={{ fontSize: 18, fontWeight: 800, color: 'white' }}>TrackrAI</span>
      ...
      <div style={{
        ...
        <div className="glass-panel" style={{ padding: 20, borderRadius: 14 }}>
          ...
          <h3 style={{ fontSize: 28, fontWeight: 800, color: 'rgb(var(--status-offer))', marginTop: 4 }}>{responseRate}%</h3>
          <div style={{ height: 4, width: '100%', background: 'rgba(255,255,255,0.05)', borderRadius: 2, marginTop: 8, overflow: 'hidden' }}>
            <div style={{ height: '100%', width: `${responseRate}%`, background: 'rgb(var(--status-offer))' }}></div>
          </div>
        </div>
        ...
        <div className="glass-panel" style={{ padding: 20, borderRadius: 14 }}>
          ...
          <h3 style={{ fontSize: 28, fontWeight: 800, color: 'rgb(var(--status-interviewing))', marginTop: 4 }}>{activeInterviews}</h3>
